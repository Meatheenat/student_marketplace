                ...
                <form action="" method="POST" id="sellerForm">
                    ...
                    <div class="checkbox-wrapper">
                        ...
                        <label for="acceptTerms" class="checkbox-label">
                            ข้าพเจ้าขอยืนยันว่าข้อมูลข้างต้นเป็นความจริง และยอมรับ <a href="#" target="_blank">เงื่อนไขการให้บริการ</a> รวมถึงการปฏิบัติตามกฎระเบียบของวิทยาลัยอย่างเคร่งครัด
                        </label>
                    </div>
