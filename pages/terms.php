...
<div style="max-width: 800px; margin: 40px auto; background: var(--bg-card); padding: 40px; border-radius: 16px; box-shadow: var(--shadow); border: 1px solid var(--border-color); color: var(--text-color); line-height: 1.6;">
    ...
    <section>
        ...
        <p>หากตรวจพบการกระทำที่ฝ่าฝืนกฎระเบียบ หรือมีการร้องเรียนว่ามีการโกงเกิดขึ้น ผู้ดูแลระบบมีสิทธิ์ระงับบัญชีผู้ใช้งานทันทีโดยไม่ต้องแจ้งให้ทราบล่วงหน้า</p>
    </section>
    ...
    <div style="margin-top: 40px; text-align: center;">
        ...
        <a href="/student_marketplace/auth/register.php" class="btn btn-primary" style="padding: 10px 25px;">ยอมรับและไปสมัครสมาชิก</a>
    </div>
