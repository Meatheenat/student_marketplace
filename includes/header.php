...
if (isset($_SESSION['profile_img']) && !empty($_SESSION['profile_img'])) {
    $user_avatar = "../assets/images/profiles/" . $_SESSION['profile_img'];
} else {
    $user_avatar = "../assets/images/profiles/default_profile.png";
}
...
<nav id="masterNavbarElement" class="master-header">
    ...
    <div class="header-layout-container">
        ...
        <div class="header-left-zone">
            ...
            <a href="../pages/index.php" class="brand-link-wrapper" aria-label="BNCC Market Home">
        ...
        <div class="header-right-zone">
            ...
            <?php if (isLoggedIn()): ?>
                ...
                <a href="../pages/chat.php" class="header-icon-btn" aria-label="Open Messages">
                ...
                <a href="../pages/profile.php" class="header-user-card" aria-label="View Profile">
            ...
            <?php else: ?>
                ...
                <?php if (!in_array($current_page, $hide_auth_list)): ?>
                    <div class="auth-action-group">
                        <a href="../auth/login.php" class="btn-auth-login">เข้าสู่ระบบ</a>
                        <a href="../auth/register.php" class="btn-auth-register">สมัครสมาชิก</a>
                    </div>
                <?php endif; ?>
...
<aside id="sidebarMasterDrawer" class="sidebar-master-drawer" aria-hidden="true" tabindex="-1">
    ...
    <nav class="sidebar-scroll-area" aria-label="Main Navigation">
        ...
        <a href="../pages/index.php" class="nav-menu-item <?= $current_page == 'index.php' ? 'is-active' : '' ?>">
            <i class="fas fa-home nav-menu-icon"></i>
            <span>หน้าหลัก</span>
        </a>
        
        <a href="../pages/wtb_board.php" class="nav-menu-item nav-item-warning <?= $current_page == 'wtb_board.php' ? 'is-active' : '' ?>">
        ...
        <?php if (isLoggedIn()): ?>
            ...
            <a href="../pages/profile.php" class="nav-menu-item <?= $current_page == 'profile.php' ? 'is-active' : '' ?>">
                <i class="fas fa-id-badge nav-menu-icon"></i>
                <span>จัดการข้อมูลบัญชี</span>
            </a>
            
            <a href="../pages/wishlist.php" class="nav-menu-item nav-item-danger <?= $current_page == 'wishlist.php' ? 'is-active' : '' ?>">
                <i class="fas fa-heart nav-menu-icon"></i>
                <span>รายการสินค้าที่ถูกใจ</span>
            </a>
            
            <a href="../pages/my_orders.php" class="nav-menu-item nav-item-success <?= $current_page == 'my_orders.php' ? 'is-active' : '' ?>">
            ...
            <?php if ($_SESSION['role'] === 'seller'): ?>
                ...
                <a href="../seller/dashboard.php" class="nav-menu-item nav-item-success">
                    <i class="fas fa-store nav-menu-icon"></i>
                    <span>แผงควบคุมร้านค้า</span>
                </a>
            <?php else: ?>
                <a href="../auth/register_seller.php" class="nav-menu-item">
            ...
            <?php if (in_array($_SESSION['role'], ['admin', 'teacher'])): ?>
                ...
                <a href="../admin/admin_dashboard.php" class="nav-menu-item nav-item-admin">
                    <i class="fas fa-shield-halved nav-menu-icon"></i>
                    <span>ศูนย์ควบคุมระบบ (Admin Panel)</span>
                </a>
                <a href="../admin/approve_product.php" class="nav-menu-item nav-item-admin">
        ...
        <?php else: ?>
            ...
            <a href="../auth/login.php" class="nav-menu-item">
                <i class="fas fa-sign-in-alt nav-menu-icon"></i>
                <span>เข้าสู่ระบบ (Login)</span>
            </a>
            
            <a href="../auth/register.php" class="nav-menu-item">
    ...
    <div class="sidebar-bottom-section">
        <a href="../auth/logout.php" class="btn-logout-massive">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const PreloaderController = {
        ...
        init() {
            ...
            // Artificial small delay to ensure CSS parses before hiding
            ...
            // Fallback fail-safe just in case 'load' event hangs
            setTimeout(() => {
     ...
     * Only loaded if PHP indicates user is logged in
     */
    <?php if(isLoggedIn()): ?>
    const NotificationController = {
        ...
        open() {
            ...
            this.fetchData(); // Refresh on open
        },
        ...
        async fetchData() {
            try {
                const response = await fetch('../ajax/notifications_api.php?action=fetch', {
                    method: 'GET',
        ...
        renderUI(data) {
            ...
            // Render List Items
            if (!this.isOpen && this.listView.innerHTML !== '') return; // Optimize DOM operations
        ...
        async executeMarkAllRead() {
            try {
                ...
                await fetch('../ajax/notifications_api.php', {
                    method: 'POST',
